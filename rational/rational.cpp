...
// Поиск множителя для сокращения дроби
...
// Операторы сложения,умножения и т.п.
    ...
    for (int i = 0; i < inputstr.size(); i++)
    {
        ...
        else if (temp <= '9' && temp >= '0')
        {
            if (dotExist)
            {
                ...
                {
                    // можно наверное сделать для больших чисел, но будет только для тех, которые входят в int
